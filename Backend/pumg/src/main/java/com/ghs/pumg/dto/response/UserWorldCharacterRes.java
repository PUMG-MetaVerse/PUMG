...
@Getter
@Setter
public class UserWorldCharacterRes extends DataResponseBody {
    @Getter
    @NoArgsConstructor
    ...
    public static UserWorldCharacterRes of(Integer statusCode, String message, User userInfo) {
        UserWorldCharacterRes res = new UserWorldCharacterRes();
